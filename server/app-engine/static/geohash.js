 ...
 */
(function(exports) {
    exports.base32 = '0123456789bcdefghjkmnpqrstuvwxyz'; // (geohash-specific) Base32 map
     ...
     */
    exports.encode = function(lat, lon, precision) {
        // infer precision?
     ...
     * @throws  Invalid geohash.
     */
    exports.bounds = function(geohash) {
     ...
     * @throws  Invalid geohash.
     */
    exports.adjacent = function(geohash, direction) {
     ...
     * @throws  Invalid geohash.
     */
    exports.neighbours = function(geohash) {
        return {
