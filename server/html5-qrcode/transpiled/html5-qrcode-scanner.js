...
var Html5QrcodeScanner = /*#__PURE__*/function () {
  ...
  _createClass(Html5QrcodeScanner, [{
    ...
    value: function __setupInitialDashboard(dashboard) {
      ...
      this.__createSectionControlPanel(); //this.__createSectionSwap();
    ...
    value: function __createSectionControlPanel() {
      ...
      requestPermissionButton.style.background = 'green';
      requestPermissionButton.style.fontSize = '64px';
    ...
    value: function __renderCameraSelection(cameras) {
      ...
      cameraActionStartButton.style.background = 'green';
      cameraActionStartButton.style.fontSize = '64px';
      cameraActionContainer.appendChild(cameraActionStartButton);
      var cameraActionStopButton = document.createElement("button");
      cameraActionStopButton.innerHTML = "Stop Scanning";
      cameraActionStopButton.style.background = 'green';
      cameraActionStopButton.style.fontSize = '64px';
      ...
      cameraActionStartButton.addEventListener('click', function (_) {
        ...
        cameraActionStartButton.disabled = true; //$this._showHideScanTypeSwapLink(false);
        ...
        console.log("- cameraId: ".concat(cameraId));
        $this.html5Qrcode.start(cameraId, config, $this.qrCodeSuccessCallback, $this.qrCodeErrorCallback).then(function (_) {
          ...
          $this._showHideScanTypeSwapLink(true); //cameraSelectionSelect.disabled = false;
