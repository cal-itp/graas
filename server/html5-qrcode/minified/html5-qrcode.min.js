...
"use strict";function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _defineProperties(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}function _createClass(e,t,n){return t&&_defineProperties(e.prototype,t),n&&_defineProperties(e,n),e}function _defineProperty(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}var Html5Qrcode=function(){function e(t,n){if(_classCallCheck(this,e),!getLazarSoftScanner)throw"Use html5qrcode.min.js without edit, getLazarSoftScannernot found.";if(this.qrcode=getLazarSoftScanner(),!this.qrcode)throw"qrcode is not defined, use the minified/html5-qrcode.min.js for proper support";this._elementId=t,this._foreverScanTimeout=null,this._localMediaStream=null,this._shouldScan=!0,this._url=window.URL||window.webkitURL||window.mozURL||window.msURL,this._userMedia=navigator.getUserMedia||navigator.webkitGetUserMedia||navigator.mozGetUserMedia||navigator.msGetUserMedia,this._isScanning=!1,e.VERBOSE=!0===n}return _createClass(e,[{key:"start",value:function(t,n,i,a){var o=this;if(!t)throw"cameraIdOrConfig is required";if(!i||"function"!=typeof i)throw"qrCodeSuccessCallback is required and should be a function.";a||(a=console.log),this._clearElement();var r=this,c=n||{};c.fps=c.fps?c.fps:e.SCAN_DEFAULT_FPS;var s=!1;c.videoConstraints&&(this._isMediaStreamConstraintsValid(c.videoConstraints)?s=!0:e._logError("'videoConstraints' is not valid 'MediaStreamConstraints, it will be ignored.'",!0));var l=s,d=null!=c.qrbox,h=document.getElementById(this._elementId),u=h.clientWidth?h.clientWidth:e.DEFAULT_WIDTH;if(h.style.position="relative",this._shouldScan=!0,this._element=h,this.qrcode.callback=i,d){var f=c.qrbox;if(f<e.MIN_QR_BOX_SIZE)throw"minimum size of 'config.qrbox' is"+" ".concat(e.MIN_QR_BOX_SIZE,"px.");if(f>u)throw"'config.qrbox' should not be greater than the width of the HTML element."}var g=function(){try{return r.qrcode.decode(),o._possiblyUpdateShaders(!0),!0}catch(e){return o._possiblyUpdateShaders(!1),a("QR code parse error, error = ".concat(e)),!1}},_=function t(){if(r._shouldScan){if(r._localMediaStream){var n=r._videoElement,i=n.videoWidth/n.clientWidth,a=n.videoHeight/n.clientHeight,s=r._qrRegion.width*i,l=r._qrRegion.height*a,d=r._qrRegion.x*i,h=r._qrRegion.y*a;r._context.drawImage(r._videoElement,d,h,s,l,0,0,r._qrRegion.width,r._qrRegion.height),g()||!0===c.disableFlip||(o._context.translate(o._context.canvas.width,0),o._context.scale(-1,1),g())}r._foreverScanTimeout=setTimeout(t,e._getTimeoutFps(c.fps))}},m=function(e){return new Promise((function(t,n){var i=function(){var i=o._createVideoElement(u);r._element.append(i),i.onabort=n,i.onerror=n,i.onplaying=function(){!function(e,t){var n=c.qrbox;n>t&&console.warn("[Html5Qrcode] config.qrboxsize is greater than video height. Shading will be ignored");var i=d&&n<=t,a={x:0,y:0,width:e,height:t},s=i?o._getShadedRegionBounds(e,t,n):a,l=o._createCanvasElement(s.width,s.height),u=l.getContext("2d");u.canvas.width=s.width,u.canvas.height=s.height,h.append(l),i&&o._possiblyInsertShadingElement(h,t,s),r._qrRegion=s,r._context=u,r._canvasElement=l}(i.clientWidth,i.clientHeight),_(),t()},i.srcObject=e,i.play(),r._videoElement=i};if(r._localMediaStream=e,l||!c.aspectRatio)i();else{var a={aspectRatio:c.aspectRatio};e.getVideoTracks()[0].applyConstraints(a).then((function(e){return i()})).catch((function(e){console.log("[Warning] [Html5Qrcode] Constriants could not be satisfied, ignoring constraints",e),i()}))}}))};return new Promise((function(e,n){if(navigator.mediaDevices&&navigator.mediaDevices.getUserMedia){var i=l?c.videoConstraints:r._createVideoConstraints(t);navigator.mediaDevices.getUserMedia({audio:!1,video:i}).then((function(t){m(t).then((function(t){r._isScanning=!0,e()})).catch(n)})).catch((function(e){n("Error getting userMedia, error = ".concat(e))}))}else if(navigator.getUserMedia){if("string"!=typeof t)throw"The device doesn't support navigator.mediaDevices, only supported cameraIdOrConfig in this case is deviceId parameter (string).";var a={video:{optional:[{sourceId:t}]}};navigator.getUserMedia(a,(function(t){m(t).then((function(t){r._isScanning=!0,e()})).catch(n)}),(function(e){n("Error getting userMedia, error = ".concat(e))}))}else n("Web camera streaming not supported by the browser.")}))}},{key:"stop",value:function(){this._shouldScan=!1,clearTimeout(this._foreverScanTimeout);var t=this;return new Promise((function(n,i){t.qrcode.callback=null;var a=t._localMediaStream.getVideoTracks().length,o=0,r=function(){t._localMediaStream=null,t._element.removeChild(t._videoElement),t._element.removeChild(t._canvasElement),function(){for(;t._element.getElementsByClassName(e.SHADED_REGION_CLASSNAME).length;){var n=t._element.getElementsByClassName(e.SHADED_REGION_CLASSNAME)[0];t._element.removeChild(n)}}(),t._isScanning=!1,t._qrRegion&&(t._qrRegion=null),t._context&&(t._context=null),n(!0)};t._localMediaStream.getVideoTracks().forEach((function(e){e.stop(),++o>=a&&r()}))}))}},{key:"scanFile",value:function(t,n){var i=this;if(!(t&&t instanceof File))throw"imageFile argument is mandatory and should be instance of File. Use 'event.target.files[0]'";if(n=void 0===n||n,i._isScanning)throw"Close ongoing scan before scanning a file.";var a=function t(n,i,a,o){if(n<=a&&i<=o)return{x:(a-n)/2,y:(o-i)/2,width:n,height:i};var r=n,c=i;return n>a&&(i*=a/n,n=a),i>o&&(n*=o/i,i=o),e._log("Image downsampled from "+"".concat(r,"X").concat(c)+" to ".concat(n,"X").concat(i,".")),t(n,i,a,o)};return new Promise((function(o,r){i._possiblyCloseLastScanImageFile(),i._clearElement(),i._lastScanImageFile=t;var c=new Image;c.onload=function(){var t=c.width,s=c.height,l=document.getElementById(i._elementId),d=l.clientWidth?l.clientWidth:e.DEFAULT_WIDTH,h=Math.max(l.clientHeight?l.clientHeight:s,e.FILE_SCAN_MIN_HEIGHT),u=a(t,s,d,h);if(n){var f=i._createCanvasElement(d,h,"qr-canvas-visible");f.style.display="inline-block",l.appendChild(f);var g=f.getContext("2d");g.canvas.width=d,g.canvas.height=h,g.drawImage(c,0,0,t,s,u.x,u.y,u.width,u.height)}var _=i._createCanvasElement(u.width,u.height);l.appendChild(_);var m=_.getContext("2d");m.canvas.width=u.width,m.canvas.height=u.height,m.drawImage(c,0,0,t,s,0,0,u.width,u.height);try{o(i.qrcode.decode())}catch(e){r("QR code parse error, error = ".concat(e))}},c.onerror=r,c.onabort=r,c.onstalled=r,c.onsuspend=r,c.src=URL.createObjectURL(t)}))}},{key:"clear",value:function(){this._clearElement()}},{key:"getRunningTrackCapabilities",value:function(){if(null==this._localMediaStream)throw"Scanning is not in running state, call this API only when QR code scanning using camera is in running state.";if(0==this._localMediaStream.getVideoTracks().length)throw"No video tracks found";return this._localMediaStream.getVideoTracks()[0].getCapabilities()}},{key:"applyVideoConstraints",value:function(e){var t=this;if(!e)throw"videoConstaints is required argument.";if(!this._isMediaStreamConstraintsValid(e))throw"invalid videoConstaints passed, check logs for more details";if(null==this._localMediaStream)throw"Scanning is not in running state, call this API only when QR code scanning using camera is in running state.";if(0==this._localMediaStream.getVideoTracks().length)throw"No video tracks found";return new Promise((function(n,i){"aspectRatio"in e?i("Chaning 'aspectRatio' in run-time is not yet supported."):t._localMediaStream.getVideoTracks()[0].applyConstraints(e).then((function(e){n(e)})).catch((function(e){i(e)}))}))}},{key:"_clearElement",value:function(){if(this._isScanning)throw"Cannot clear while scan is ongoing, close it first.";document.getElementById(this._elementId).innerHTML=""}},{key:"_createCanvasElement",value:function(e,t,n){var i=e,a=t,o=document.createElement("canvas");return o.style.width="".concat(i,"px"),o.style.height="".concat(a,"px"),o.style.display="none",o.id=null==n?"qr-canvas":n,o}},{key:"_createVideoElement",value:function(e){var t=document.createElement("video");return t.style.width="".concat(e,"px"),t.muted=!0,t.playsInline=!0,t}},{key:"_getShadedRegionBounds",value:function(e,t,n){if(n>e||n>t)throw"'config.qrbox' should not be greater than the width and height of the HTML element.";return{x:(e-n)/2,y:(t-n)/2,width:n,height:n}}},{key:"_possiblyInsertShadingElement",value:function(t,n,i){var a=this;if(0!=i.x||0!=i.y){var o={};o[e.SHADED_LEFT]=this._createShadedElement(n,i,e.SHADED_LEFT),o[e.SHADED_RIGHT]=this._createShadedElement(n,i,e.SHADED_RIGHT),o[e.SHADED_TOP]=this._createShadedElement(n,i,e.SHADED_TOP),o[e.SHADED_BOTTOM]=this._createShadedElement(n,i,e.SHADED_BOTTOM),Object.keys(o).forEach((function(e){return t.append(o[e])})),i.x<10||i.y<10?this.hasBorderShaders=!1:(Object.keys(o).forEach((function(e){return a._insertShaderBorders(o[e],i,e)})),this.hasBorderShaders=!0)}}},{key:"_createShadedElement",value:function(t,n,i){var a=document.createElement("div");switch(a.style.position="absolute",a.style.height="".concat(t,"px"),a.className=e.SHADED_REGION_CLASSNAME,a.id="".concat(e.SHADED_REGION_CLASSNAME,"_").concat(i),a.style.background="#0000007a",i){case e.SHADED_LEFT:a.style.top="0px",a.style.left="0px",a.style.width="".concat(n.x,"px"),a.style.height="".concat(t,"px");break;case e.SHADED_RIGHT:a.style.top="0px",a.style.right="0px",a.style.width="".concat(n.x,"px"),a.style.height="".concat(t,"px");break;case e.SHADED_TOP:a.style.top="0px",a.style.left="".concat(n.x,"px"),a.style.width="".concat(n.width,"px"),a.style.height="".concat(n.y,"px");break;case e.SHADED_BOTTOM:var o=n.y+n.height;a.style.top="".concat(o,"px"),a.style.left="".concat(n.x,"px"),a.style.width="".concat(n.width,"px"),a.style.height="".concat(n.y,"px");break;default:throw"Unsupported shadingPosition"}return a}},{key:"_insertShaderBorders",value:function(t,n,i){i=parseInt(i);var a=this,o=40,r=function(n,o){if(null===n||null===o)throw"Shaders should have defined positions";var r=function(){var t=document.createElement("div");switch(t.style.position="absolute",t.style.backgroundColor=e.BORDER_SHADER_DEFAULT_COLOR,i){case e.SHADED_LEFT:case e.SHADED_RIGHT:t.style.width="".concat(5,"px"),t.style.height="".concat(45,"px");break;case e.SHADED_TOP:case e.SHADED_BOTTOM:t.style.width="".concat(45,"px"),t.style.height="".concat(5,"px");break;default:throw"Unsupported shadingPosition"}return t}();r.style.top="".concat(n,"px"),r.style.left="".concat(o,"px"),t.appendChild(r),a.borderShaders||(a.borderShaders=[]),a.borderShaders.push(r)},c=null,s=null,l=null,d=null;switch(i){case e.SHADED_LEFT:c=n.y-5,s=n.x-5,l=n.y+n.height-o,d=s;break;case e.SHADED_RIGHT:c=n.y-5,s=0,l=n.y+n.height-o,d=s;break;case e.SHADED_TOP:s=-5,l=c=n.y-5,d=n.width-o;break;case e.SHADED_BOTTOM:s=-5,l=c=0,d=n.width-o;break;default:throw"Unsupported shadingPosition"}r(c,s),r(l,d)}},{key:"_possiblyUpdateShaders",value:function(t){this.qrMatch!==t&&(this.hasBorderShaders&&this.borderShaders&&this.borderShaders.length&&this.borderShaders.forEach((function(n){n.style.backgroundColor=t?e.BORDER_SHADER_MATCH_COLOR:e.BORDER_SHADER_DEFAULT_COLOR})),this.qrMatch=t)}},{key:"_possiblyCloseLastScanImageFile",value:function(){this._lastScanImageFile&&(URL.revokeObjectURL(this._lastScanImageFile),this._lastScanImageFile=null)}},{key:"_createVideoConstraints",value:function(e){if("string"==typeof e)return{deviceId:{exact:e}};if("object"!=_typeof(e)){var t=_typeof(e);throw"Invalid type of 'cameraIdOrConfig' = ".concat(t)}var n="facingMode",i="deviceId",a={user:!0,environment:!0},o="exact",r=function(e){if(e in a)return!0;throw"config has invalid 'facingMode' value = "+"'".concat(e,"'")},c=Object.keys(e);if(1!=c.length)throw"'cameraIdOrConfig' object should have exactly 1 key,"+" if passed as an object, found ".concat(c.length," keys");var s=Object.keys(e)[0];if(s!=n&&s!=i)throw"Only '".concat(n,"' and '").concat(i,"' ")+" are supported for 'cameraIdOrConfig'";if(s!=n){var l=e[s];if("string"==typeof l)return{deviceId:l};if("object"==_typeof(l)){if(o in l)return{deviceId:{exact:l.exact}};throw"'deviceId' should be string or object with"+" ".concat(o," as key.")}var d=_typeof(l);throw"Invalid type of 'deviceId' = ".concat(d)}var h=e[s];if("string"==typeof h){if(r(h))return{facingMode:h}}else{if("object"!=_typeof(h)){var u=_typeof(h);throw"Invalid type of 'facingMode' = ".concat(u)}if(!(o in h))throw"'facingMode' should be string or object with"+" ".concat(o," as key.");if(r(h.exact))return{facingMode:{exact:h.exact}}}}},{key:"_isMediaStreamConstraintsValid",value:function(t){if(!t)return e._logError("Empty videoConstraints",!0),!1;if("object"!==_typeof(t)){var n=_typeof(t);return e._logError("videoConstraints should be of type object, the "+"object passed is of type ".concat(n,"."),!0),!1}for(var i=new Set(["autoGainControl","channelCount","echoCancellation","latency","noiseSuppression","sampleRate","sampleSize","volume"]),a=Object.keys(t),o=0;o<a.length;o++){var r=a[o];if(i.has(r))return e._logError("".concat(r," is not supported videoConstaints."),!0),!1}return!0}}],[{key:"getCameras",value:function(){var e=this;return new Promise((function(t,n){if(navigator.mediaDevices&&navigator.mediaDevices.enumerateDevices&&navigator.mediaDevices.getUserMedia)e._log("navigator.mediaDevices used"),navigator.mediaDevices.getUserMedia({audio:!1,video:!0}).then((function(i){i.oninactive=function(t){return e._log("All streams closed")};navigator.mediaDevices.enumerateDevices().then((function(n){for(var a=[],o=0;o<n.length;o++){var r=n[o];"videoinput"==r.kind&&a.push({id:r.deviceId,label:r.label})}e._log("".concat(a.length," results found")),function(e){for(var t=e.getVideoTracks(),n=0;n<t.length;n++){var i=t[n];i.enabled=!1,i.stop(),e.removeTrack(i)}}(i),t(a)})).catch((function(e){n("".concat(e.name," : ").concat(e.message))}))})).catch((function(e){n("".concat(e.name," : ").concat(e.message))}));else if(MediaStreamTrack&&MediaStreamTrack.getSources){e._log("MediaStreamTrack.getSources used");MediaStreamTrack.getSources((function(n){for(var i=[],a=0;a!==n.length;++a){var o=n[a];"video"===o.kind&&i.push({id:o.id,label:o.label})}e._log("".concat(i.length," results found")),t(i)}))}else e._log("unable to query supported devices."),n("unable to query supported devices.")}))}},{key:"_getTimeoutFps",value:function(e){return 1e3/e}},{key:"_log",value:function(t){e.VERBOSE&&console.log(t)}},{key:"_logError",value:function(t,n){(e.VERBOSE||!0===n)&&console.error(t)}}]),e}();_defineProperty(Html5Qrcode,"DEFAULT_WIDTH",300),_defineProperty(Html5Qrcode,"DEFAULT_WIDTH_OFFSET",2),_defineProperty(Html5Qrcode,"FILE_SCAN_MIN_HEIGHT",300),_defineProperty(Html5Qrcode,"SCAN_DEFAULT_FPS",2),_defineProperty(Html5Qrcode,"MIN_QR_BOX_SIZE",50),_defineProperty(Html5Qrcode,"SHADED_LEFT",1),_defineProperty(Html5Qrcode,"SHADED_RIGHT",2),_defineProperty(Html5Qrcode,"SHADED_TOP",3),_defineProperty(Html5Qrcode,"SHADED_BOTTOM",4),_defineProperty(Html5Qrcode,"SHADED_REGION_CLASSNAME","qr-shaded-region"),_defineProperty(Html5Qrcode,"VERBOSE",!1),_defineProperty(Html5Qrcode,"BORDER_SHADER_DEFAULT_COLOR","#ffffff"),_defineProperty(Html5Qrcode,"BORDER_SHADER_MATCH_COLOR","rgb(90, 193, 56)");


/** Html5QrcodeScanner **/
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _defineProperties(e,t){for(var n=0;n<t.length;n++){var a=t[n];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}function _createClass(e,t,n){return t&&_defineProperties(e.prototype,t),n&&_defineProperties(e,n),e}function _defineProperty(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}var Html5QrcodeScanner=function(){function e(t,n,a){if(_classCallCheck(this,e),this.elementId=t,this.config=n,this.verbose=!0===a,!document.getElementById(t))throw"HTML Element with id=".concat(t," not found");this.currentScanType=e.SCAN_TYPE_CAMERA,this.sectionSwapAllowed=!0,this.section=void 0,this.html5Qrcode=void 0,this.qrCodeSuccessCallback=void 0,this.qrCodeErrorCallback=void 0}return _createClass(e,[{key:"render",value:function(t,n){var a=this;this.lastMatchFound=void 0,this.qrCodeSuccessCallback=function(n){if(a.__setStatus("MATCH",e.STATUS_SUCCESS),t)t(n);else{if(a.lastMatchFound==n)return;a.lastMatchFound=n,a.__setHeaderMessage("Last Match: ".concat(n),e.STATUS_SUCCESS)}},this.qrCodeErrorCallback=function(e){a.__setStatus("Scanning"),n&&n(e)};var i=document.getElementById(this.elementId);i.innerHTML="",this.__createBasicLayout(i),this.html5Qrcode=new Html5Qrcode(this.__getScanRegionId(),this.verbose)}},{key:"clear",value:function(){var e=this,t=this;if(this.html5Qrcode)return new Promise((function(n,a){t.html5Qrcode._isScanning&&t.html5Qrcode.stop().then((function(a){var i;t.html5Qrcode.clear(),(i=document.getElementById(e.elementId))&&(i.innerHTML="",e.__resetBasicLayout(i)),n()})).catch((function(e){t.verbose&&console.error("Unable to stop qrcode scanner",e),a(e)}))}))}},{key:"__createBasicLayout",value:function(e){e.style.position="relative",e.style.padding="0px",e.style.border="1px solid silver",this.__createHeader(e);var t=document.createElement("div"),n=this.__getScanRegionId();t.id=n,t.style.width="100%",t.style.minHeight="100px",t.style.textAlign="center",e.appendChild(t),this.__insertCameraScanImageToScanRegion();var a=document.createElement("div"),i=this.__getDashboardId();a.id=i,a.style.width="100%",e.appendChild(a),this.__setupInitialDashboard(a)}},{key:"__resetBasicLayout",value:function(e){e.style.border="none"}},{key:"__setupInitialDashboard",value:function(e){this.__createSection(e),this.__createSectionControlPanel()}},{key:"__createHeader",value:function(e){var t=document.createElement("div");t.style.textAlign="left",t.style.margin="0px",t.style.padding="5px",t.style.fontSize="20px",t.style.borderBottom="1px solid rgba(192, 192, 192, 0.18)",e.appendChild(t);var n=document.createElement("span");n.innerHTML="QR Code Scanner",t.appendChild(n);var a=document.createElement("span");a.id=this.__getStatusSpanId(),a.style.float="right",a.style.padding="5px 7px",a.style.fontSize="14px",a.style.background="#dedede6b",a.style.border="1px solid #00000000",a.style.color="rgb(17, 17, 17)",t.appendChild(a),this.__setStatus("IDLE");var i=document.createElement("div");i.id=this.__getHeaderMessageContainerId(),i.style.display="none",i.style.fontSize="14px",i.style.padding="2px 10px",i.style.marginTop="4px",i.style.borderTop="1px solid #f6f6f6",t.appendChild(i)}},{key:"__createSection",value:function(e){var t=document.createElement("div");t.id=this.__getDashboardSectionId(),t.style.width="100%",t.style.padding="10px",t.style.textAlign="left",e.appendChild(t)}},{key:"__createSectionControlPanel",value:function(){var t=this,n=document.getElementById(this.__getDashboardSectionId()),a=document.createElement("div");n.appendChild(a);var i=document.createElement("div");i.id=this.__getDashboardSectionCameraScanRegionId(),i.style.display=this.currentScanType==e.SCAN_TYPE_CAMERA?"block":"none",a.appendChild(i);var c=document.createElement("div");c.style.textAlign="center";var r=document.createElement("button");r.innerHTML="Request Camera Permissions",r.style.background="green",r.style.fontSize="64px",r.addEventListener("click",(function(){r.disabled=!0,t.__setStatus("PERMISSION"),t.__setHeaderMessage("Requesting camera permissions..."),Html5Qrcode.getCameras().then((function(n){t.__setStatus("IDLE"),t.__resetHeaderMessage(),n&&0!=n.length?(i.removeChild(c),t.__renderCameraSelection(n)):t.__setStatus("No Cameras",e.STATUS_WARNING)})).catch((function(n){r.disabled=!1,t.__setStatus("IDLE"),t.__setHeaderMessage(n,e.STATUS_WARNING)}))})),c.appendChild(r),i.appendChild(c);var s=document.createElement("div");s.id=this.__getDashboardSectionFileScanRegionId(),s.style.textAlign="center",s.style.display=this.currentScanType==e.SCAN_TYPE_CAMERA?"none":"block",a.appendChild(s);var o=document.createElement("input");o.id=this.__getFileScanInputId(),o.accept="image/*",o.type="file",o.style.width="200px",o.disabled=this.currentScanType==e.SCAN_TYPE_CAMERA;var d=document.createElement("span");d.innerHTML="&nbsp; Select Image",s.appendChild(o),s.appendChild(d),o.addEventListener("change",(function(n){if(t.currentScanType===e.SCAN_TYPE_FILE&&0!=n.target.files.length){var a=n.target.files[0];t.html5Qrcode.scanFile(a,!0).then((function(e){t.__resetHeaderMessage(),t.qrCodeSuccessCallback(e)})).catch((function(n){t.__setStatus("ERROR",e.STATUS_WARNING),t.__setHeaderMessage(n,e.STATUS_WARNING),t.qrCodeErrorCallback(n)}))}}))}},{key:"__renderCameraSelection",value:function(t){var n=this,a=document.getElementById(this.__getDashboardSectionCameraScanRegionId());a.style.textAlign="center";var i=document.createElement("span"),c=document.createElement("button");c.innerHTML="Start Scanning",c.style.background="green",c.style.fontSize="64px",i.appendChild(c);var r=document.createElement("button");r.innerHTML="Stop Scanning",r.style.background="green",r.style.fontSize="64px",r.style.display="none",r.disabled=!0,i.appendChild(r),a.appendChild(i),c.addEventListener("click",(function(a){c.disabled=!0;var i=n.config?n.config:{fps:10,qrbox:250},s=t[0].id;console.log("- cameraId: ".concat(s)),n.html5Qrcode.start(s,i,n.qrCodeSuccessCallback,n.qrCodeErrorCallback).then((function(e){r.disabled=!1,r.style.display="inline-block",c.style.display="none",n.__setStatus("Scanning")})).catch((function(t){n._showHideScanTypeSwapLink(!0),c.disabled=!1,n.__setStatus("IDLE"),n.__setHeaderMessage(t,e.STATUS_WARNING)}))})),r.addEventListener("click",(function(t){r.disabled=!0,n.html5Qrcode.stop().then((function(e){c.disabled=!1,r.style.display="none",c.style.display="inline-block",n.__setStatus("IDLE"),n.__insertCameraScanImageToScanRegion()})).catch((function(t){r.disabled=!1,n.__setStatus("ERROR",e.STATUS_WARNING),n.__setHeaderMessage(t,e.STATUS_WARNING)}))}))}},{key:"__createSectionSwap",value:function(){var t=this,n="Scan an Image File",a="Scan using camera directly",i=document.getElementById(this.__getDashboardSectionId()),c=document.createElement("div");c.style.textAlign="center";var r=document.createElement("a");r.style.textDecoration="underline",r.id=this.__getDashboardSectionSwapLinkId(),r.innerHTML=this.currentScanType==e.SCAN_TYPE_CAMERA?n:a,r.href="#scan-using-file",r.addEventListener("click",(function(){t.sectionSwapAllowed?(t.__setStatus("IDLE"),t.__resetHeaderMessage(),t.__getFileScanInput().value="",t.sectionSwapAllowed=!1,t.currentScanType==e.SCAN_TYPE_CAMERA?(t.__clearScanRegion(),t.__getFileScanInput().disabled=!1,t.__getCameraScanRegion().style.display="none",t.__getFileScanRegion().style.display="block",r.innerHTML=a,t.currentScanType=e.SCAN_TYPE_FILE,t.__insertFileScanImageToScanRegion()):(t.__clearScanRegion(),t.__getFileScanInput().disabled=!0,t.__getCameraScanRegion().style.display="block",t.__getFileScanRegion().style.display="none",r.innerHTML=n,t.currentScanType=e.SCAN_TYPE_CAMERA,t.__insertCameraScanImageToScanRegion()),t.sectionSwapAllowed=!0):t.verbose&&console.error("Section swap called when not allowed")})),c.appendChild(r),i.appendChild(c)}},{key:"__setStatus",value:function(t,n){n||(n=e.STATUS_DEFAULT);var a=document.getElementById(this.__getStatusSpanId());switch(a.innerHTML=t,n){case e.STATUS_SUCCESS:a.style.background="#6aaf5042",a.style.color="#477735";break;case e.STATUS_WARNING:a.style.background="#cb243124",a.style.color="#cb2431";break;case e.STATUS_DEFAULT:default:a.style.background="#eef",a.style.color="rgb(17, 17, 17)"}}},{key:"__resetHeaderMessage",value:function(){document.getElementById(this.__getHeaderMessageContainerId()).style.display="none"}},{key:"__setHeaderMessage",value:function(t,n){n||(n=e.STATUS_DEFAULT);var a=document.getElementById(this.__getHeaderMessageContainerId());switch(a.innerHTML=t,a.style.display="block",n){case e.STATUS_SUCCESS:a.style.background="#6aaf5042",a.style.color="#477735";break;case e.STATUS_WARNING:a.style.background="#cb243124",a.style.color="#cb2431";break;case e.STATUS_DEFAULT:default:a.style.background="#00000000",a.style.color="rgb(17, 17, 17)"}}},{key:"_showHideScanTypeSwapLink",value:function(e){!0!==e&&(e=!1),this.sectionSwapAllowed=e,this.__getDashboardSectionSwapLink().style.display=e?"inline-block":"none"}},{key:"__insertCameraScanImageToScanRegion",value:function(){var t=this,n=document.getElementById(this.__getScanRegionId());if(this.cameraScanImage)return n.innerHTML="<br>",void n.appendChild(this.cameraScanImage);this.cameraScanImage=new Image,this.cameraScanImage.onload=function(e){n.innerHTML="<br>",n.appendChild(t.cameraScanImage)},this.cameraScanImage.width=64,this.cameraScanImage.style.opacity=.3,this.cameraScanImage.src=e.ASSET_CAMERA_SCAN}},{key:"__insertFileScanImageToScanRegion",value:function(){var t=this,n=document.getElementById(this.__getScanRegionId());if(this.fileScanImage)return n.innerHTML="<br>",void n.appendChild(this.fileScanImage);this.fileScanImage=new Image,this.fileScanImage.onload=function(e){n.innerHTML="<br>",n.appendChild(t.fileScanImage)},this.fileScanImage.width=64,this.fileScanImage.style.opacity=.3,this.fileScanImage.src=e.ASSET_FILE_SCAN}},{key:"__clearScanRegion",value:function(){document.getElementById(this.__getScanRegionId()).innerHTML=""}},{key:"__getDashboardSectionId",value:function(){return"".concat(this.elementId,"__dashboard_section")}},{key:"__getDashboardSectionCameraScanRegionId",value:function(){return"".concat(this.elementId,"__dashboard_section_csr")}},{key:"__getDashboardSectionFileScanRegionId",value:function(){return"".concat(this.elementId,"__dashboard_section_fsr")}},{key:"__getDashboardSectionSwapLinkId",value:function(){return"".concat(this.elementId,"__dashboard_section_swaplink")}},{key:"__getScanRegionId",value:function(){return"".concat(this.elementId,"__scan_region")}},{key:"__getDashboardId",value:function(){return"".concat(this.elementId,"__dashboard")}},{key:"__getFileScanInputId",value:function(){return"".concat(this.elementId,"__filescan_input")}},{key:"__getStatusSpanId",value:function(){return"".concat(this.elementId,"__status_span")}},{key:"__getHeaderMessageContainerId",value:function(){return"".concat(this.elementId,"__header_message")}},{key:"__getCameraSelectionId",value:function(){return"".concat(this.elementId,"__camera_selection")}},{key:"__getCameraScanRegion",value:function(){return document.getElementById(this.__getDashboardSectionCameraScanRegionId())}},{key:"__getFileScanRegion",value:function(){return document.getElementById(this.__getDashboardSectionFileScanRegionId())}},{key:"__getFileScanInput",value:function(){return document.getElementById(this.__getFileScanInputId())}},{key:"__getDashboardSectionSwapLink",value:function(){return document.getElementById(this.__getDashboardSectionSwapLinkId())}}]),e}();_defineProperty(Html5QrcodeScanner,"SCAN_TYPE_CAMERA","SCAN_TYPE_CAMERA"),_defineProperty(Html5QrcodeScanner,"SCAN_TYPE_FILE","SCAN_TYPE_FILE"),_defineProperty(Html5QrcodeScanner,"STATUS_SUCCESS","STATUS_SUCCESS"),_defineProperty(Html5QrcodeScanner,"STATUS_WARNING","STATUS_WARNING"),_defineProperty(Html5QrcodeScanner,"STATUS_DEFAULT","STATUS_DEFAULT"),_defineProperty(Html5QrcodeScanner,"ASSET_FILE_SCAN","https://raw.githubusercontent.com/mebjas/html5-qrcode/master/assets/file-scan.gif"),_defineProperty(Html5QrcodeScanner,"ASSET_CAMERA_SCAN","https://raw.githubusercontent.com/mebjas/html5-qrcode/master/assets/camera-scan.gif");
